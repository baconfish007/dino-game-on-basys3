...
#
# Script generated by Vivado on Sun May 24 16:06:11 +0800 2026
...
# script info
echo -e "image_rom.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot image_rom xil_defaultlib.image_rom xil_defaultlib.glbl -log elaborate.log
}
...
Usage: image_rom.sh [-rerun]\n\
Usage: image_rom.sh [-reset_run]\n\
Usage: image_rom.sh [-clean]\n\
